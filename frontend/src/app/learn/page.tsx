...
const LetterSelection: React.FC = () => {
  ...
  //   const starCount = Math.round((accuracy / 100) * 3);
...
//   return (
//     <div key={letter} className="flex flex-col items-center w-20 h-20 relative">
//       <button
//         onClick={() => isUnlocked && handleLetterClick(letter)}
//         disabled={!isUnlocked}
//         className={`w-full h-full flex flex-col justify-center items-center px-2 py-2 text-lg font-semibold border rounded relative transition
//           bg-white text-black 
//           ${!isUnlocked ? "opacity-50 cursor-not-allowed" : "hover:bg-blue-500 hover:text-white"}`}
//       >
//         {/* Letter with lock overlay */}
//         <div className="relative">
//           <span>{letter}</span>
//           {!isUnlocked && (
//             <Lock className="absolute inset-0 m-auto text-gray-600 w-5 h-5 opacity-70 pointer-events-none" />
//           )}
//         </div>
